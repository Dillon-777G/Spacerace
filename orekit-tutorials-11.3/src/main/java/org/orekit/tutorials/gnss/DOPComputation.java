...
public class DOPComputation {
    ...
    public static void main(final String[] args) {
        ...
        } catch (URISyntaxException | OrekitException e) {
     ...
     * @param minElevation minimum elevation for visibility (rad)
     * @param tStart start of computation period
     * @param tStop end of computation period
