...
public class TutorialOrbit {
    ...
    private TutorialOrbitType orbitType;
     ...
     */
    public void setOrbitType(final TutorialOrbitType orbitType) {
    ...
    public Frame getInertialFrame() {
        ...
        throw new OrekitException(TutorialOrbitDetermination.UNKNOWN_FRAME, name);
