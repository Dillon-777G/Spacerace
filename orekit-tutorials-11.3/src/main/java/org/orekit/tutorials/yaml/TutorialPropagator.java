...
public class TutorialPropagator {
    ...
    private TutorialIntegrator integrator;

    /** Force model data. */
    private TutorialForceModel forceModels;
     ...
     */
    public void setIntegrator(final TutorialIntegrator integrator) {
     ...
     */
    public void setForceModels(final TutorialForceModel forceModels) {
