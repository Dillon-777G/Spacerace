 ...
 */
public class TutorialOrbitType {

    /** Name of the orbit type. */
    private String name;

    /** Cartesian orbit elements. */
    private TutorialCartesianOrbit cartesian;

    /** Keplerian orbit elements. */
    private TutorialKeplerianOrbit keplerian;

    /** Equinoctial orbit elements. */
    private TutorialEquinoctialOrbit equinoctial;

    /** Circular orbit elements. */
    private TutorialCircularOrbit circular;
     ...
     */
    public TutorialCartesianOrbit getCartesian() {
        return cartesian;
    }
     ...
     */
    public void setCartesian(final TutorialCartesianOrbit cartesian) {
     ...
     */
    public TutorialKeplerianOrbit getKeplerian() {
        return keplerian;
    }
     ...
     */
    public void setKeplerian(final TutorialKeplerianOrbit keplerian) {
     ...
     */
    public TutorialEquinoctialOrbit getEquinoctial() {
        return equinoctial;
    }
     ...
     */
    public void setEquinoctial(final TutorialEquinoctialOrbit equinoctial) {
     ...
     */
    public TutorialCircularOrbit getCircular() {
        return circular;
    }
     ...
     */
    public void setCircular(final TutorialCircularOrbit circular) {
    ...
    /** Cartesian orbit. */
    public static class TutorialCartesianOrbit {
    ...
    /** Keplerian orbit. */
    public static class TutorialKeplerianOrbit {
    ...
    /** Equinoctial orbit. */
    public static class TutorialEquinoctialOrbit {
    ...
    /** Circular orbit. */
    public static class TutorialCircularOrbit {
    ...
    /** TLE data. */
    public static class TutorialTLE {
