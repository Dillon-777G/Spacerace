 ...
 */
class RangeRateParser extends MeasurementsParser<RangeRate> {
    /** {@inheritDoc} */
    @Override
    public RangeRate parseFields(final String[] fields,
        ...
        final RangeRate rangeRate = new RangeRate(stationData.getStation(),
                                                  getDate(fields[0], line, lineNumber, fileName),
                                                  isMeters ? Double.parseDouble(fields[3]) :
                                                             Double.parseDouble(fields[3]) * 1000.0,
                                                  stationData.getRangeRateSigma(),
                                                  weights.getRangeRateBaseWeight(),
                                                  true, satellite);
