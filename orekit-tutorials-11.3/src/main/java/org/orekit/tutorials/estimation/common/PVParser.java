    ...
    public PV parseFields(final String[] fields,
        ...
        return new org.orekit.estimation.measurements.PV(getDate(fields[0], line, lineNumber, fileName),
                                                         new Vector3D(isMeters ? Double.parseDouble(fields[3]) :
                                                                      ...
                                                                      isMeters ? Double.parseDouble(fields[4]) :
                                                                                 Double.parseDouble(fields[4]) * 1000.0,
                                                                      isMeters ? Double.parseDouble(fields[5]) :
                                                                                 Double.parseDouble(fields[5]) * 1000.0),
                                                         new Vector3D(isMeters ? Double.parseDouble(fields[6]) :
                                                                                 Double.parseDouble(fields[6]) * 1000.0,
                                                                      isMeters ? Double.parseDouble(fields[7]) :
                                                                                 Double.parseDouble(fields[7]) * 1000.0,
                                                                      isMeters ? Double.parseDouble(fields[8]) :
