...
/**
 * Orekit tutorial for Global Navigation Satellite System (GNSS)
 * orbit determination.
 * @author Bryan Cazabonne
 */
public class GNSSOrbitDetermination extends AbstractOrbitDetermination<NumericalPropagatorBuilder> {
    ...
    public static void main(final String[] args) {
        try {
            ...
            final String inputPath = GNSSOrbitDetermination.class.getClassLoader().
                                     getResource("gnss-od/orbit-determination-GPS07.yaml").toURI().getPath();
            new GNSSOrbitDetermination().run(new File(inputPath));
    ...
    protected List<ParameterDriver> setManeuver(final NumericalPropagatorBuilder propagatorBuilder, final AbsoluteDate fireDate,
        ...
        throw new OrekitException(LocalizedCoreFormats.SIMPLE_MESSAGE,
                                  "Maneuvers not implemented for GNSSOrbitDetermination");
    }
