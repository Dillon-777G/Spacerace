...
public class Frames3 {
    ...
    public static void main(final String[] args) {
        try {
            ...
            final Frame eme2000 = FramesFactory.getEME2000(); // inertial frame
            final Orbit orbit = new CircularOrbit(7178000.0, 0.5e-4, -0.5e-4,
            ...
            final NadirPointing nadirLaw = new NadirPointing(eme2000, earth);

            // Target pointing attitude provider with yaw compensation
            final PVCoordinatesProvider sun = CelestialBodyFactory.getSun();
            final YawSteering yawSteeringLaw =
            ...
            propagator.getMultiplexer().add(10, new OrekitFixedStepHandler() {
                ...
                public void init(final SpacecraftState s0, final AbsoluteDate t, final double step) {
                    try {
                        final File file = new File(home, "XYZ.dat");
                ...
                public void handleStep(final SpacecraftState currentState) {
                    ...
                    final Transform inertToSpacecraft = currentState.toTransform();

                    // get the position of the Sun in orbit/attitude reference frame
                    final Vector3D sunInert = sun.getPVCoordinates(currentState.getDate(), currentState.getFrame()).getPosition();
                    ...
                    final Vector3D spin = inertToSpacecraft.getRotationRate();
